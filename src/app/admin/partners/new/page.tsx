...
import { ArrowLeft, Save, Upload, Link2, X, ImageIcon } from "lucide-react";
    ...
    return (
        <div>
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Tambah Mitra</h1>
                    <p className="text-gray-500 mt-1">Tambahkan mitra baru untuk ditampilkan di website</p>
                </div>
            </div>
