    ...
    return (
        <section className="relative py-32 lg:py-48 overflow-hidden bg-white">
            ...
            <div className="absolute inset-0">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-conic from-violet-200/30 via-fuchsia-200/30 via-40% to-violet-200/30 rounded-full blur-[100px] animate-spin-slow" />
            </div>
            ...
            <div className="container relative mx-auto px-4 lg:px-8">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    {heading && (
                        <h2 className="text-5xl md:text-6xl lg:text-8xl font-bold text-slate-900 mb-8 leading-[1.1] tracking-tight">
                            ...
                            <span className="relative inline-block">
                                <span className="relative z-10 bg-gradient-to-r from-violet-600 via-fuchsia-600 to-pink-600 bg-clip-text text-transparent">
                                    {heading.split(' ').slice(-1)[0]}
                                </span>
                                <span className="absolute -bottom-2 left-0 w-full h-3 bg-gradient-to-r from-violet-500/30 to-fuchsia-500/30 blur-xl" />
                            </span>
                        </h2>
                    )}
                    ...
                    {ctaPrimaryLabel && ctaPrimaryHref && (
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            <Link href={ctaPrimaryHref}>
                                <Button
                                    size="lg"
                                    className="group relative bg-slate-900 text-white hover:bg-slate-800 px-10 py-7 text-base font-semibold rounded-full overflow-hidden transition-all duration-500 hover:shadow-[0_0_50px_rgba(0,0,0,0.2)] hover:-translate-y-1"
                                >
                            ...
                            <Link
                                href="/features"
                                className="group flex items-center gap-3 text-slate-500 hover:text-slate-900 transition-all duration-300"
                            >
                                <span className="text-base font-medium">Pelajari fitur lengkap</span>
                    ...
                    <div className="absolute top-1/2 right-20 w-2 h-2 bg-violet-500 rounded-full animate-pulse" />
                    <div className="absolute top-1/3 left-20 w-2 h-2 bg-fuchsia-500 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
                </div>
            </div>
        </section>
    );
